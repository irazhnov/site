const menuMock = [
    {label: 'Therapies', slug:'diabetes-therapies', id: '00',
      submenu: [
        ...
        {label: 'Central Dopamine', slug: 'central-dopamine'},
        ...
        {label: 'Insulin Therapy', slug:'insulin'},
        {label: 'Meglitinides', slug: 'meglitinides'},
        {label: 'Metformin Therapy', slug:'metformin'},
        {label: 'Physical Activity', slug: 'physical-activity'},
        {label: 'SGLT-2 Therapy', slug:'sglt-2'},
        {label: 'Sulfonylurea', slug:'sulfonylurea'},
        {label: 'Surgery', slug: 'surgery'},
        {label: 'Transplants', slug: 'transplants'},
        ]
    },
    {
    ...
    label: 'Specialties', slug: 'specialties', id: '02',
      submenu: [
        ...
        {label: 'Geriatric Medicine', slug: 'geriatrics'},
...
//     ]},
    { label: 'For Your Practice', slug: 'for-your-practice', id: '04',
      submenu: [
        ...
        {label: 'Patient Mobile Apps', slug: 'patient-mobile-apps'},
        {label: 'Patient Resources', slug: 'resources-for-diabetes-patients'},
